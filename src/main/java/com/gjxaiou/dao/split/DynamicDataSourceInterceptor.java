...
/**
 * MyBatis 级别的拦截器，该拦截器会拦截MyBatis 传递进来的 SQL 信息，然后根据 SQL 信息来选择
 * * @author GJXAIOU
 *
 * @create 2019-10-20-21:08
 */
// 因为 insert 和 update 和 delete  会封装到 update 中，不要单独表明了；
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (synchronizationActive != true) {
            ...
            if (ms.getSqlCommandType().equals(SqlCommandType.SELECT)) {
                // 如果 selectKey 为自增 id 查询主键，即mybatis 使用了select Last_insert_ID()，方法,
                // 因为后续包括图片，这种情况下使用主库
